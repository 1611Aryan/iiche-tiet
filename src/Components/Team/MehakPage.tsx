...
const MehakPage: React.FC<{
  ...
  return (
    <StyledMehakPage ref={pageRef}>
      <div className="front">
        {" "}
        <div className="row one">
          <Picture images={[{ imgSrc: mehak_jpg, type: "img/jpg" }]} />
          <div className="content">
            <div>
              <h4>Name</h4>
              <span>Mehak Chandel</span>
            </div>
            <div>
              <h4>Designation</h4>
...
const StyledMehakPage = styled(Page)`
  .front {
    display: flex;
