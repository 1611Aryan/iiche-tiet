...
const LokeshwarPage: React.FC<{
  ...
  return (
    <StyledLokeshwarPage ref={pageRef}>
      <div className="front">
        {" "}
        <div className="row one">
          <Picture images={[{ imgSrc: lokeshwar_jpg, type: "img/jpg" }]} />
          <div className="content">
            <div>
              <h4>Name</h4>
              <span>Lokeshwar Puri</span>
            </div>
            <div>
              <h4>Designation</h4>
...
const StyledLokeshwarPage = styled(Page)`
  .front {
    display: flex;
