...
const JaskaranPage: React.FC<{
  ...
  return (
    <StyledJaskaranPage ref={pageRef}>
      <div className="front">
        {" "}
        <div className="row one">
          <Picture images={[{ imgSrc: jaskaran_jpg, type: "img/jpg" }]} />
          <div className="content">
            <div>
              <h4>Name</h4>
              <span>Jaskaran Singh Ubhi</span>
            </div>
            <div>
              <h4>Designation</h4>
              <span>Engagement Head</span>
            </div>
          </div>
        </div>
        <div className="row">
...
const StyledJaskaranPage = styled(Page)`
  .front {
    display: flex;
