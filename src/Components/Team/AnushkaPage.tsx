...
const AnushkaPage: React.FC<{
  ...
  return (
    <StyledAnushkaPage ref={pageRef}>
      <div className="front">
        {" "}
        <div className="row one">
          <Picture images={[{ imgSrc: anushka_jpg, type: "img/jpg" }]} />
          <div className="content">
            <div>
              <h4>Name</h4>
              <span>Anushka Khera</span>
            </div>
            <div>
              <h4>Designation</h4>
...
const StyledAnushkaPage = styled(Page)`
  .front {
    display: flex;
